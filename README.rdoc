...
NB: While you can use Ruby (and Rails) constructs in your ccs.erb files, these 
are evaluated ONCE ONLY on the first production request after deployment. 
This means you cannot use dynamic variables in the ccs.erb files (e.g. for session based information)
